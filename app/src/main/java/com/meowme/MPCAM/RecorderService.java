...
public class RecorderService extends Service {
	...
	public void onCreate() {
		...
		mServiceCamera = MPCAM.mCamera;
		mSurfaceView = MPCAM.mSurfaceView;
		mSurfaceHolder = MPCAM.mSurfaceHolder;
	...
	public boolean startRecording(){
		try {
			...
			mMediaRecorder.setOutputFile(getExternalStorageDirectory() + "/" +
